                                                                            ...
                                                                            if (imdbId) idCache.set(cacheKey, imdbId);
                                                                                return imdbId;
                                                                                  ...
                                                                                  function traktItemToImdb(traktItem) {
                                                                                    const media = traktItem.movie || traktItem.show || traktItem.episode;
                                                                                      ...
                                                                                      function traktItemToStremioId(traktItem) {
                                                                                        const imdb = traktItemToImdb(traktItem);
                                                                                          if (imdb) return imdb;
                                                                                            const media = traktItem.movie || traktItem.show;
                                                                                              const tmdb  = media?.ids?.tmdb;
                                                                                                if (tmdb) { const type = traktItem.movie ? 'movie' : 'series'; return `tmdb:${type}:${tmdb}`; }
                                                                                                  return null;
                                                                                                  }

                                                                                                  function traktItemToType(traktItem) {
                                                                                                    if (traktItem.movie) return 'movie';
                                                                                                      if (traktItem.show || traktItem.episode) return 'series';
                                                                                                        return 'movie';
                                                                                                        }
